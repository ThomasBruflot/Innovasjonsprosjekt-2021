...
const int startPinA = 29;
const int stopPinA = 33;
const int ledA = 28;
...
void setup()
{
  ...
  tft2.setRotation((iliRotation)1);

  //Display logo on both screens for 3 seconds
  tft.drawImage(logocurlwatch_2, 0, 0, logocurlwatch_2Width, logocurlwatch_2Height);
  tft2.drawImage(logocurlwatch_2, 0, 0, logocurlwatch_2Width, logocurlwatch_2Height);
  delay(3000);
